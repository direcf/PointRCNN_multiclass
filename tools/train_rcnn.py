...
def create_dataloader(logger):
    ...
    # print("train_set",train_set) # <lib.datasets.kitti_rcnn_dataset.KittiRCNNDataset object at 0x7f9ae0b8b470>
    train_loader = DataLoader(train_set, batch_size=args.batch_size, pin_memory=True,
                              num_workers=args.workers, shuffle=True, collate_fn=train_set.collate_batch,
                              drop_last=True)
    # print("train_loader",train_loader) # <torch.utils.data.dataloader.DataLoader object at 0x7f9ae0c63cc0>
...
if __name__ == "__main__":
    ...
    # print("logger",logger) #  <Logger __main__ (DEBUG)>
    # logger.info('**********************Start logging**********************')

    # log to file
    gpu_list = os.environ['CUDA_VISIBLE_DEVICES'] if 'CUDA_VISIBLE_DEVICES' in os.environ.keys() else 'ALL'
    # logger.info('CUDA_VISIBLE_DEVICES=%s' % gpu_list)
    #### this part prints key, val 
    ...
    print("2 : Create dataloader & network & optimizer")
